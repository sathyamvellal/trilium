    ...
    getRootWidget(appContext) {
        ...
        return new RootContainer()
            ...
            .child(new FlexContainer("column")
                ...
                .child(new CalendarWidget("bx-notepad", "Logs", "logs", "week", "monday"))
                .child(new CalendarWidget("bx-bug", "Bugs", "bugsUpdates", "week", "tuesday"))
                .child(new CalendarWidget("bx-receipt", "Status", "streamingCoreStatus", "week", "thursday"))
                .child(new CalendarWidget("bx-git-pull-request", "Reviews", "reviews", "month"))
