            ...
            children: [
                ...
                },
                {
                    ...
                    children: [
                        ...
                        { id: '_lbCalendar', title: 'Logs', type: 'launcher', builtinWidget: 'calendar', icon: 'bx bx-calendar', calendarRootLabel: 'calendarRoot', calendarNoteType: 'day', calendarStartOfTheWeek: 'monday' },
                        { id: '_lbCalendarRecords', title: 'Records', type: 'launcher', builtinWidget: 'calendar', icon: 'bx bx-receipt', calendarRootLabel: 'recordsRoot', calendarNoteType: 'day', calendarStartOfTheWeek: 'monday' },
                        { id: '_lbCalendarJournal', title: 'Journal', type: 'launcher', builtinWidget: 'calendar', icon: 'bx bx-book', calendarRootLabel: 'journalRoot', calendarNoteType: 'day', calendarStartOfTheWeek: 'monday' },
